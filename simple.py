...
# Tamaño de entrada esperado por el modelo
input_shape = (1, 31, 31, 1)  # Actualizar a una dimensión de tamaño 4
...
image = image.resize((input_shape[1], input_shape[2]))  # Redimensionar

# Preprocesamiento de la imagen
image_array = np.array(image) / 255.0

# Asegurarse de que las dimensiones de la imagen sean correctas
if image_array.shape != input_shape[1:3]:
    image_array = np.resize(image_array, input_shape[1:3])
